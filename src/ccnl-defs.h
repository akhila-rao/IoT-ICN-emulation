...
// Verify these before setting up evaluations
#define CCNL_CONTENT_TIMEOUT            200 // sec
#define CCNL_INTEREST_TIMEOUT           200  // sec
#define CCNL_MAX_INTEREST_RETRANSMIT    0
#define CACHE_PROB                      100 // percentage
//#define OCCUPANCY_WEIGHT                1 // (0,1)
//#define EXPIRY_TIME_WEIGHT              0 // (0,1) they should add up to 1
#define CS_SAVE_PERIOD                  1 //sec
#define ACTIVE_DROP_PROB                0.01 // in percentage
#define OUTAGE_DROP_PROB                0.50 // in percentage
#define ALPHA                           0.01 // prob of going from active to outage
#define BETA                            0.05 //prob of going from outage to active
#define STEP_SCALE                      10
#define INITIAL_STATE                   0 // Active state. Initial state for the Markov chain series of correlated losses
#define MAX_NETWORK_LEVEL_INTEREST_RETRANSMIT   10 // this is number of retransmissions. Number of transmissions is this +1
// #define CCNL_FACE_TIMEOUT    60 // sec
#define CCNL_FACE_TIMEOUT       15 // sec
#define CCNL_DEFAULT_MAX_CACHE_ENTRIES  1  // 0 means no caching
#define CCNL_MAX_NONCES                 256 // for detected dups
#define PUBLISHING_TIMEPERIOD 2.0 //(double) seconds
